...
public class ListAluno extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jT_Aluno = new javax.swing.JTable();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setResizable(false);

        jT_Aluno.setAutoCreateRowSorter(true);
        jT_Aluno.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Código", "Nome", "Sobrenome", "Cidade"
            }
        ) {
        ...
        jT_Aluno.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_NEXT_COLUMN);
        jT_Aluno.setColumnSelectionAllowed(true);
        jT_Aluno.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jScrollPane2.setViewportView(jT_Aluno);
        jT_Aluno.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
    ...
    private void iniciarBD() {
        ...
        try {
            ...
            rsListar = stmtListar.executeQuery("select *from ALUNO");
    ...
    private javax.swing.JTable jT_Aluno;
    // End of variables declaration//GEN-END:variables

    private void montarTabela() {
        int linha = 0;

        DefaultTableModel tb = (DefaultTableModel) jT_Aluno.getModel();
        ...
        try {
            ...
            while (rsListar.next()) {
                ...
                String CODCID = rsListar.getString("CODCIDADE");
                int aux = Integer.parseInt(CODCID);

                String nome = "" + cidadeDao.getNomeCidadeByCod(aux);

                //Adiciona as informações no JTable seguindo os parametros (info,linha,coluna).
                tb.addRow(new String[]{COD, NOME, SOBRENOME, nome});
            ...
            Logger.getLogger(ListAluno.class.getName()).log(Level.SEVERE, null, ex);
        }
